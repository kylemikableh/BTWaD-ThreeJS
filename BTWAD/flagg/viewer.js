...
function init() {
    ...
    lightLoader();
    loadGround();
    loadModel(manager,'./demoFiles/george_flagg_house',3000,0,6000,2.5,2.5,2.5,0,'house2');
    loadModel(manager,'./demoFiles/george_flagg_icehouse',-3000,-20,0,2,2,2,0,'house3');
    renderHelper();
    addWater();
...
function showDivWithID(id) {
    let divs = ['george-house', 'george-icehouse']
