...
function init() {
    ...
    lightLoader();
    loadGround();
    loadModel(manager,'./demoFiles/persis_andrews_barn_away_from_house',3000,0,6000,2,2,2,0,'house2');
    loadModel(manager,'./demoFiles/persis_andrews_house_sorry_jasper',-3000,-20,0,1.75,1.75,1.75,0,'house3');
    loadModel(manager,'./demoFiles/persis_andrews_barn_behind_house',-3000,-20,-6000,1.75,1.75,1.75,0,'house4');
    renderHelper();
    addWater();
...
function showDivWithID(id) {
    let divs = ['persis-house', 'persis-barn1', 'persis-barn2']
