...
function init() {
    ...
    lightLoader();
    loadGround();
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b2',3000,0,6000,2,2,2,0,'house2');
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b1',-3000,-20,0,2,2,2,0,'house3');
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b3',-3000,-150,-6000,2,2,2,0,'house4');
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b4',0,-20,-3000,2,2,2,0,'house5');
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b5',-6000,-20,-3000,2,2,2,0,'house6');
    loadModel(manager,'./demoFiles/thomas_k_cunningham_b6',-6000,-20,3000,2,2,2,0,'house7');
    renderHelper();
    addWater();
...
function showDivWithID(id) {
    let divs = ['cunning-b1', 'cunning-b2', 'cunning-b3', 'cunning-b4', 'cunning-b5', 'cunning-b6'];
