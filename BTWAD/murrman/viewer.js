...
function init() {
    ...
    lightLoader();
    loadGround();
    loadModel(manager,'./demoFiles/george_murrmann_house',3000,0,6000,2.5,2.5,2.5,0,'house2');
    loadModel(manager,'./demoFiles/george_murrmann_barn',-3000,-20,0,3,3,3,0,'house3');
    renderHelper();
    addWater();
...
function showDivWithID(id) {
    let divs = ['murrman-barn', 'murrman-house']
